...
/***/ function(module, exports, __webpack_require__) {
	...
	var Componentss = (function () {
	  function Componentss() {
	    _classCallCheck(this, Componentss);
	  }

	  _createClass(Componentss, null, [{
	    key: 'init',
	    value: function init() {

	      console.log("hello from components");

	      var Toolbox = _react2['default'].createClass({
	        displayName: "Toolbox",
	      ...
	      _react2['default'].render(_react2['default'].createElement(Toolbox, null), $("#toolbox")[0]);
	    }
	  }]);
	...
	$(function () {
	  return Componentss.init();
	});

	exports['default'] = Componentss;
	module.exports = exports['default'];
